...
void Image_Save_Png(Image i, const char* name); //WRITE  IMAGE AS PNG
...
void Image_Save_Png(Image i, const char* name) { //WRITE IMAGE AS JPG

	stbi_write_png(name,(int)(i.width / i.chanels),i.height,i.chanels,i.pixels, 0);
	}
